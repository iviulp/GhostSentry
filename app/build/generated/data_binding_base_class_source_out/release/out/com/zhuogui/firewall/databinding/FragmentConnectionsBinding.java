...
public final class FragmentConnectionsBinding implements ViewBinding {
  ...
  private FragmentConnectionsBinding(@NonNull LinearLayout rootView, @NonNull Button btnClear,
  ...
  public static FragmentConnectionsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentConnectionsBinding((LinearLayout) rootView, btnClear, recyclerView,
          tvCount, tvEmpty);
    }
